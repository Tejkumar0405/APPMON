...
GetOptions('object=s' => \$Object,'monitor_status=s' => \$monitorStatus,'command=s' => \$mycmd, 'search_string=s' => \$stringToSearch , 'exclude_string=s' => \$stringToExclude,'inverse' => \$inverseMode, 'trigger=s' => \$trigger,'suppress_matchedoutput' => \$suppressMatchedLines,'debug_enabled' => \$debugEnabled);
